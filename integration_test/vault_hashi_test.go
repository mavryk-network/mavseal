...
func TestHashiVault(t *testing.T) {
	...
	out, err := MavkitClient("import", "secret", "key", "hashimv1", "http://mavseal:6732/"+pkh)
...
func hashiGetMv1() string {
	...
	if err != nil {
		panic("hashiGetMv1: mavseal-cli returned an error: " + string(out))
	}
	var mv1 string
...
// the vault hostname in MavSeal config file needs to match a CN in the SSL Cert
